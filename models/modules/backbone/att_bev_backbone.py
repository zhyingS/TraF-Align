...
from models.modules.fusion.attfuse_self_attn import AttFusion
from models.modules.utils.auto_encoder import AutoEncoder
import spconv
...
class AttBEVBackbone(nn.Module):
    def __init__(self, cfg):
        ...
        self.cfg = cfg
        self.compress = False
        input_channels= cfg['model']['reader']['num_filters'][-1]
        self.one_batch = cfg['dataset']['frame_his'] + 1

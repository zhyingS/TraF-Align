...
from models.modules.fusion.attfuse_self_attn import ScaledDotProductAttention
...
class Communication(nn.Module):
    def __init__(self, args):
        ...
        if 'gaussian_smooth' in args:
            ...
            self.gaussian_filter.bias.requires_grad = False
        else:
            self.smooth = False
    ...
    def forward(self, batch_confidence_maps, B):
        ...
        communication_rates = []
        for b in range(B):
            B_,C_,H_,W_ = batch_confidence_maps[b].shape
            if B_ == 0:
                continue            
        ...
        if self.multi_scale:
            ...
            for i in range(self.num_levels):
                ...
                for b in range(B):
                    ...
                    B_, C_, H_, W_ = neighbor_feature.shape
                    if B_ == 0:
                        neighbor_feature = torch.zeros((1,C_,H_,W_)).type_as(neighbor_feature)
